...
public class FragmentMost extends Fragment {
    ...
    private final String addedFrom = "most_page";
    ...
    private void getData() {
        if (helper.isNetworkAvailable()) {
            ...
            }, helper.callAPI(Callback.METHOD_MOST_VIEWED, page, "", "", "", "", sharedPref.getUserId(), "", "", "", "", "", "", "", null));
            loadRadio.execute();
        } else {
