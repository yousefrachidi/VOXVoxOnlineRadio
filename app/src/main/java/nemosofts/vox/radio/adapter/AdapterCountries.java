...
public class AdapterCountries extends RecyclerView.Adapter {
    ...
    private final ArrayList<ItemCountries> arrayList;
    ...
    public AdapterCountries(Context context, ArrayList<ItemCountries> arrayList, RecyclerItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            final ItemCountries item = arrayList.get(position);
    ...
    public interface RecyclerItemClickListener{
        void onClickListener(ItemCountries itemCountries, int position);
    }
